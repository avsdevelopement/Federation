<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmClgReturnReg.aspx.cs" Inherits="FrmClgReturnReg" %>
                                        ...
                                        <div class="row" style="margin-bottom: 10px;">
                                            <div class="row" style="margin: 20px; border-bottom: 1px solid rgba(53, 152, 220, 0.55);"><strong></strong></div>
                                             <div class="row" style="margin: 7px 0 7px 0">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="TxtFDate" onkeyup="FormatIt(this)" Placeholder="From Date" OnTextChanged="TxtFDate_TextChanged" onkeypress="javascript:return isNumber (event)" CssClass="form-control" runat="server" AutoPostBack="true"></asp:TextBox>
                                                    </div>
                                                    <label class="control-label col-md-1">To Date<span class="required">*</span></label>
                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="TxtTDate" onkeyup="FormatIt(this)" Placeholder="From Date" OnTextChanged="TxtTDate_TextChanged" onkeypress="javascript:return isNumber (event)" CssClass="form-control" runat="server" AutoPostBack="true"></asp:TextBox>
                                                    </div>
                                            ...
                                            <div class="row" style="margin: 7px 0 7px 0">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-4">
                                                        <asp:RadioButton ID="Rdb_IwR" runat="server" Text="Inward Return" AutoPostBack="true" GroupName="TYPE1" />
                                                        <asp:RadioButton ID="Rdb_OwR" runat="server" Text="Outward Return" AutoPostBack="true" GroupName="TYPE1" />

                                                    </div>
                                                    <label class="control-label col-md-2">Type 2<span class="required">* </span></label>
                                                    <div class="col-md-4">
                                                        <asp:RadioButton ID="Rdb_Sum" runat="server" Text="Summary" AutoPostBack="true" GroupName="TYPE2" />
                                                        <asp:RadioButton ID="Rdb_Det" runat="server" Text="Details" AutoPostBack="true" GroupName="TYPE2" />
