<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmProductTransDetails.aspx.cs" Inherits="FrmProductTransDetails" %>
                            ...
                            <div class="form-body">
                                    ...
                                    <div style="border: 1px solid #3598dc">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:RadioButtonList ID="RbtlType" RepeatDirection="Horizontal" CssClass="radio-list" runat="server">
                                                        <asp:ListItem Text="Details" Value="DT" style="margin:15px;" />
                                                        <asp:ListItem Text="Day Wise" Value="D" style="margin:15px;" />
                                                        <asp:ListItem Text="Month Wise" Value="M" style="margin:15px;" />
                                                    </asp:RadioButtonList>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 12px; margin-bottom: 10px;">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-2">
                                                    <asp:TextBox ID="TxtFDate" placeholder="DD/MM/YYYY" onkeyup="DateValid(this)" onkeypress="javascript:return isNumber (event)" CssClass="form-control" runat="server"></asp:TextBox>
                                                ...
                                                <div class="col-md-2">
                                                    <asp:TextBox ID="TxtTDate" placeholder="DD/MM/YYYY" onkeyup="DateValid(this)" onkeypress="javascript:return isNumber (event)" CssClass="form-control" runat="server"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-lg-6" style="text-align: center">
                                        ...
                                        <asp:Button ID="btnSumryPrint" runat="server" CssClass="btn btn-primary" Text="Summary Report Print" OnClick="btnSumryPrint_Click" OnClientClick="Javascript:return Validate();" />
                                    </div>
                                </div>
                            </div>
                        </div>
