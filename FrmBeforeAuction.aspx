<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/CBSMaster.master" CodeFile="FrmBeforeAuction.aspx.cs" Inherits="FrmBeforeAuction" %>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn blue" Text="Gold Auction Before notice" OnClick= "btnSubmit_Click"  OnClientClick="Javascript:return isvalidate();" />
