<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmRegister.aspx.cs" Inherits="FrmRegister" %>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="BtnDSS" runat="server" Text="DSS Report" />
                                        ...
                                        <asp:Button ID="BtnLoanR" runat="server" Text="Loan Report" Visible="false" OnClick="BtnLoanR_Click" CssClass="btn btn-primary" />
                                        <asp:Button ID="BtnDepositR" runat="server" Text="Deposit Report" Visible="false" OnClick="BtnDepositR_Click" CssClass="btn btn-primary" />
                                    </div>
                                </div>
                            </div>
                        </div>
