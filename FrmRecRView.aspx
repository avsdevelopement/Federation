<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmRecRView.aspx.cs" Inherits="FrmRecRView" %>
...
<body>
      <form id="form1" runat="server">
        ...
        <div>
            ...
            <rsweb:ReportViewer ID="RdlcPrint" runat="server" Width="100%" Height="690" ShowParameterPrompts="true"  ShowPrintButton="true" AsyncRendering="False" SizeToReportContent="True" PageCountMode="Actual" >
