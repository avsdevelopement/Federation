...
public partial class FrmOrgBranchTrans : System.Web.UI.Page
{
    ClsInsertTrans ITrans = new ClsInsertTrans();
    ClsBindDropdown BD = new ClsBindDropdown();
    ClsOrgBranchTrans MV = new ClsOrgBranchTrans();
    ...
    protected void DdlCRDR_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            else if (DdlCRDR.SelectedValue == "2" && ddlPMTMode.SelectedValue == "3")
            {
                ViewState["GlCode"] = "99";
                TxtPtype.Text = "99";
                TxtAccNo.Text = "0";
                    ...
                    if (DT.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < DT.Rows.Count; i++)
                        {
                            ...
                            resultout = ITrans.InsertMTable(Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), DT.Rows[i]["GLCODE"].ToString(), DT.Rows[i]["SUBGLCODE"].ToString(), DT.Rows[i]["ACCNO"].ToString(),
                                        DT.Rows[i]["PARTICULARS"].ToString(), DT.Rows[i]["PARTICULARS2"].ToString(), Convert.ToDouble(DT.Rows[i]["AMOUNT"].ToString()), DT.Rows[i]["TrxType"].ToString(), "3", "CR", SetNo, DT.Rows[i]["InstNo"].ToString(), DT.Rows[i]["InstDate"].ToString(), "0", "0", "1001",
                            ...
                            if (resultout > 0)
                            {
                                //Insert Data to Original Table (InterBranchTrans)
                                resultout = ITrans.InsertIBTTable(DT.Rows[i]["BRCD"].ToString(), Session["EntryDate"].ToString(), DT.Rows[i]["GLCODE"].ToString(), DT.Rows[i]["SUBGLCODE"].ToString(), DT.Rows[i]["ACCNO"].ToString(),
                                            DT.Rows[i]["PARTICULARS"].ToString(), DT.Rows[i]["PARTICULARS2"].ToString(), Convert.ToDouble(DT.Rows[i]["AMOUNT"].ToString()), DT.Rows[i]["TrxType"].ToString(), "3", "CR", SetNo, DT.Rows[i]["InstNo"].ToString(), DT.Rows[i]["InstDate"].ToString(), "1001",
                                            Session["MID"].ToString(), "0", PayMast.ToString(), DT.Rows[i]["CUSTNO"].ToString(), DT.Rows[i]["CustName"].ToString(), DT.Rows[i]["RefBrcd"].ToString(), DT.Rows[i]["OrgBrCd"].ToString(), DT.Rows[i]["ResBrCd"].ToString(), ViewState["RID"].ToString());
                            }
                        }
                    }
                }
                    ...
                    if (DT.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < DT.Rows.Count; i++)
                        {
                            ...
                            if (resultout > 0)
                            {
                                //Insert Data to Original Table (InterBranchTrans)
                                resultout = ITrans.InsertIBTTable(DT.Rows[i]["BRCD"].ToString(), Session["EntryDate"].ToString(), DT.Rows[i]["GLCODE"].ToString(), DT.Rows[i]["SUBGLCODE"].ToString(), DT.Rows[i]["ACCNO"].ToString(),
                                            DT.Rows[i]["PARTICULARS"].ToString(), DT.Rows[i]["PARTICULARS2"].ToString(), Convert.ToDouble(DT.Rows[i]["AMOUNT"].ToString()), DT.Rows[i]["TrxType"].ToString(), "7", "TR", SetNo, DT.Rows[i]["InstNo"].ToString(), DT.Rows[i]["InstDate"].ToString(), "1001",
                                            Session["MID"].ToString(), "0", PayMast.ToString(), DT.Rows[i]["CUSTNO"].ToString(), DT.Rows[i]["CustName"].ToString(), DT.Rows[i]["RefBrcd"].ToString(), DT.Rows[i]["OrgBrCd"].ToString(), DT.Rows[i]["ResBrCd"].ToString(), ViewState["RID"].ToString());
                            }
                        }
                    }
