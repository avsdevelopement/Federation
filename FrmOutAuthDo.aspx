<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmOutAuthDo.aspx.cs" Inherits="FrmOutAuthDo" %>
                                                    ...
                                                    <asp:TableCell ID="tbl_Col1" runat="server" Width="70%">
                                                        ...
                                                        <div class="row" style="margin: 7px 0 7px 0">
                                                            <div class="col-lg-11">
                                                                ...
                                                                <label class="control-label col-md-2">Set No : <span class="required"></span></label>
                                                                <div class="col-md-3">
                                                        ...
                                                        <div class="row" style="margin: 7px 0 7px 0">
                                                            <div class="col-lg-11">
                                                                <label class="control-label col-md-3">Operation Type : <span class="required">* </span></label>
                                                                <div class="col-md-3">
                                                        ...
                                                        <div class="row" style="margin: 7px 0 7px 0">
                                                            <div class="col-lg-11">
                                                                <label class="control-label col-md-3">Particulars : <span class="required">* </span></label>
                                                                <div class="col-md-3">
                                                                    <asp:TextBox ID="txtpartic" CssClass="form-control" runat="server" Text="By Clg" ReadOnly="True"></asp:TextBox>
                                                                </div>
                                                                <label class="control-label col-md-2">Instrument Type <span class="required">* </span></label>
                                                                <div class="col-md-3">
                                                                    <%--<asp:TextBox ID="ddlinsttype" CssClass="form-control" runat="server" Text="By Clg" ReadOnly="True"></asp:TextBox>--%>
                                                        ...
                                                        <div class="row" style="margin: 7px 0 7px 0">
                                                            <div class="col-lg-11">
                                                                <label class="control-label col-md-3">Instrument No. : <span class="required">* </span></label>
                                                                <div class="col-md-3">
                                                        ...
                                                        <div class="row" style="margin: 7px 0 7px 0">
                                                            <div class="col-lg-11">
                                                                <label class="control-label col-md-3">Instrument Amount : <span class="required">* </span></label>
                                                                <div class="col-md-3">
