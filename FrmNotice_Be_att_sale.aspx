<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/CBSMaster.master" CodeFile="FrmNotice_Be_att_sale.aspx.cs" Inherits="FrmNotice_Be_att_sale" %>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn blue" Text="Report" OnClick=  "btnSubmit_Click" OnClientClick="Javascript:return isvalidate();" />
