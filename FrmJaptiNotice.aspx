<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CBSMaster.master" CodeFile="FrmJaptiNotice.aspx.cs" Inherits="FrmJaptiNotice" %>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn blue" Text="Raid Report" OnClick=  "btnSubmit_Click" OnClientClick="Javascript:return isvalidate();" />
