<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CBSMaster.master" CodeFile="FrmVisitNotice.aspx.cs" Inherits="FrmVisitNotice" %>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn blue" Text="Visit Notice" OnClick=  "btnSubmit_Click"  OnClientClick="Javascript:return isvalidate();" />
