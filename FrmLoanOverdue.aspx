<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmLoanOverdue.aspx.cs" Inherits="FrmLoanOverdue" %>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="tab1">
                                                ...
                                                <div class="row" style="margin: 7px 0 7px 0">
                                                    <div class="col-lg-12">
                                                        <div class="col-md-1">
                                                            <asp:CheckBox ID="Chk_Address" runat="server" Text="Show Address" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row" style="margin: 7px 0 7px 0">
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <asp:Button ID="New_Report" runat="server" Text="Loan Balance Report" CssClass="btn btn-success" OnClick="New_Report_Click" />
