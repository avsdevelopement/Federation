<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmChequeIssue.aspx.cs" Inherits="FrmChequeIssue" %>
...
<script type="text/javascript">
    function isvalidate() {
        ...
        var InstFrom = document.getElementById('<%=txtInstFrom.ClientID%>').value;
        var InstTo = document.getElementById('<%=txtInstTo.ClientID%>').value;
            ...
            if (InstFrom == "") {
                var message = 'Please Enter From Series Number....!!\n';
                $('#alertModal').find('.modal-body p').text(message);
                $('#alertModal').modal('show')
                document.getElementById('<%=txtInstFrom.ClientID%>').focus();
                return false;
            }
            if (InstTo == "") {
                var message = 'Please Enter To Series Number....!!\n';
                $('#alertModal').find('.modal-body p').text(message);
                $('#alertModal').modal('show')
                document.getElementById('<%=txtInstTo.ClientID%>').focus();
                return false;
            }
        }
    </script>
                                    ...
                                    <div class="tab-pane active" id="tab1">
                                        ...
                                        <div class="row" style="margin: 7px 0 7px 0">
                                            <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-4">
                                                        <asp:TextBox ID="txtProdName" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtProdName_TextChanged"></asp:TextBox>
                                        ...
                                        <div class="row" style="margin: 7px 0 7px 0">
                                            <div class="col-lg-12">
                                                <label class="control-label col-md-2">Instrument From <span class="required">*</span></label>
                                                <div class="col-lg-3">
                                                    <asp:TextBox ID="txtInstFrom" OnTextChanged="txtInstFrom_TextChanged" AutoPostBack="true" onkeypress="javascript:return isNumber (event)" CssClass="form-control" runat="server" />
                                                </div>
                                                <div class="col-lg-3">
                                                    <asp:TextBox ID="txtInstTo" onkeypress="javascript:return isNumber (event)" CssClass="form-control" runat="server" />
                                                </div>
                                           </div>
                                        </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <asp:Button ID="btnAuthorize" runat="server" CssClass="btn blue" Text="Authorised" OnClick="btnAuthorize_Click" />
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover" width="100%">
                            <thead>
                                <tr>
                                    <th>
                                        <asp:GridView ID="grdChequeIssue" runat="server" AllowPaging="True" AlternatingRowStyle-CssClass="alt" CssClass="mGrid" AutoGenerateColumns="false"
                                            EditRowStyle-BackColor="#FFFF99" OnPageIndexChanging="grdChequeIssue_PageIndexChanging" PagerStyle-CssClass="pgr" Width="100%">
                                            <Columns>
