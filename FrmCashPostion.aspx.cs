...
public partial class FrmCashPostion : System.Web.UI.Page
{
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string redirectURL = "FrmRView.aspx?BRCD=" + TxtBrID.Text + "&AsOnDate=" + Conn.ConvertDate(TxtAsonDate.Text).ToString() + "&rptname=RptCashPostionReport.rdlc" + "";
