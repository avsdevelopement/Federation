<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmAvs51211.aspx.cs" Inherits="FrmAvs51211" %>
                        ...
                        <div class="form-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div style="border: 1px solid #3598dc" runat="server" >
                                        <div class="row" style="margin-bottom: 10px;">
                                            ...
                                            <div class="row" style="margin: 7px 0 7px 0">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="txtCaseY" MaxLength="5" TabIndex="1" CssClass="form-control" runat="server" Placeholder="YY-YY" onkeyup="Year(this)" onkeypress="javascript:return isNumber (event)"></asp:TextBox>
                                                    </div>
                                                    <label class="control-label col-md-3">Case No<span class="required">*</span></label>
                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="txtCaseNO" CssClass="form-control" TabIndex="2" Placeholder="Case No" OnTextChanged="txtCaseNO_TextChanged" runat="server" AutoPostBack="true" onkeypress="javascript:return isNumber (event)"></asp:TextBox>
                                            ...
                                            <div class="row" style="margin: 7px 0 7px 0">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="txtDate" Placeholder="DD/MM/YYYY" TabIndex="3" CssClass="form-control" runat="server" onkeyup="FormatIt(this)" onkeypress="javascript:return isNumber (event)"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="txtmem" CssClass="form-control" AutoPostBack="true" TabIndex="4" onkeypress="javascript:return isNumber (event)" PlaceHolder="Society Type & MemberNo" runat="server"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin: 7px 0 7px 0">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <asp:TextBox ID="txtSocietyName" Placeholder="Society Name" TabIndex="5" Width="318px" onkeydown="return CheckFirstChar(event.keyCode, this);" onkeypress="javascript:return OnltAlphabets(event)" CssClass="form-control" runat="server" AutoPostBack="true"></asp:TextBox>
                                                    </div>
                                                    <label class="control-label col-md-2">Society Address<span class="required">*</span></label>
                                                    <div class="col-md-3">
                                                        <asp:TextBox ID="txtSociadd" Placeholder="Society Address" TextMode="MultiLine" TabIndex="6" onkeydown="return CheckFirstChar(event.keyCode, this);" onkeypress="javascript:return OnltAlphabets(event)" CssClass="form-control" runat="server" AutoPostBack="true"></asp:TextBox>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="Div5" runat="server" class="row" style="margin: 7px 0 7px 0">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <asp:TextBox ID="txtdefaltername" Width="318px" Placeholder="Defaulter Name" TabIndex="7" onkeydown="return CheckFirstChar(event.keyCode, this);" onkeypress="javascript:return OnltAlphabets(event)" CssClass="form-control" runat="server" AutoPostBack="true"></asp:TextBox>
                                                    </div>
                                            ...
                                            <div id="Div2" runat="server" class="row" style="margin: 7px 0 7px 0">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="txtCity" Placeholder="City" TabIndex="8" CssClass="form-control" runat="server" AutoPostBack="true"></asp:TextBox>
                                                    </div>
                                                    <label class="control-label col-md-3">Pincode<span class="required">*</span></label>

                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="txtPincode" CssClass="form-control" runat="server" TabIndex="9" MaxLength="6" onkeypress="javascript:return isNumber(event)" placeholder="Pincode"></asp:TextBox>
                                            ...
                                            <div id="Div3" runat="server" class="row" style="margin: 7px 0 7px 0">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="txtrcno" onkeypress="javascript:return isNumber (event)" TabIndex="10" Placeholder="R.C.NO." onkeydown="return CheckFirstChar(event.keyCode, this);" CssClass="form-control" runat="server" AutoPostBack="true"></asp:TextBox>
                                                    </div>
                                                    <label class="control-label col-md-3">R.C.DATE<span class="required">*</span></label>

                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="txtMovDate" CssClass="form-control" runat="server" onkeyup="FormatIt(this)" TabIndex="11" onkeypress="javascript:return isNumber(event)" placeholder="dd/mm/yyyy"></asp:TextBox>
                                ...
                                <div class="row" style="margin: 7px 0 7px 0">
                                    <div class="col-lg-10">
                                        ...
                                        <div class="col-md-6">
                                            <asp:Button ID="BtnSubmit" runat="server" CssClass="btn btn-primary" Text="Submit" TabIndex="16" OnClick="BtnSubmit_Click1" OnClientClick="Javascript:return IsValide()" />
                                            <asp:Button ID="BtnClear" runat="server" CssClass="btn btn-primary" Text="Clear" TabIndex="17" OnClick="BtnClear_Click" />
                                            <asp:Button ID="BtnExit" runat="server" CssClass="btn btn-primary" OnClick="BtnExit_Click" TabIndex="18" Text="Exit" />
                                        </div>
                                        <div class="row">
                                                ...
                                                <div class="table-scrollable" style="border: none">
                                                    <table class="table table-striped table-bordered table-hover">
                                                        <thead>
                                                            <tr>
                                                                <th>
                                                                    <asp:GridView ID="GridAction" runat="server" AllowPaging="True"
                                                                        AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="False"
                                                                        EditRowStyle-BackColor="#FFFF99"
                                                                        PageIndex="10" PageSize="10"
                                                                        PagerStyle-CssClass="pgr">
                                                                         <HeaderStyle Font-Bold="true" BackColor="LightBlue" Width ="10px" VerticalAlign="Middle" />
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="APPLICTION DATE">
                                                                                <ItemTemplate>
                                                                            ...
                                                                            <%--<asp:TemplateField HeaderText="SOCIETY ADDRESS">
                                                                                <ItemTemplate>
                                                                           ...
                                                                           <%-- <asp:TemplateField HeaderText="DECRETAL AMOUNT">
                                                                                <ItemTemplate>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="ACTION STATUS">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="ACTIONSTATUS1" runat="server" Text='<%# Eval("ACTIONSTATUS") %>' Style="padding:50px"></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
