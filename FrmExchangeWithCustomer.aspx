<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmExchangeWithCustomer.aspx.cs" Inherits="FrmExchangeWithCustomer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function TakeTotal() {
            ...
            var NG2000 = document.getElementById('<%=txtGAmt1.ClientID%>').value || 0;
            var NG1000 = document.getElementById('<%=txtGAmt2.ClientID%>').value || 0;
            var NG500 = document.getElementById('<%=txtGAmt3.ClientID%>').value || 0;
            var NG200 = document.getElementById('<%=txtGAmt12.ClientID%>').value || 0;
            var NG100 = document.getElementById('<%=txtGAmt4.ClientID%>').value || 0;
            var NG50 = document.getElementById('<%=txtGAmt5.ClientID%>').value || 0;
            var NG20 = document.getElementById('<%=txtGAmt6.ClientID%>').value || 0;
            var NG10 = document.getElementById('<%=txtGAmt7.ClientID%>').value || 0;
            var NG5 = document.getElementById('<%=txtGAmt8.ClientID%>').value || 0;
            var NG2 = document.getElementById('<%=txtGAmt9.ClientID%>').value || 0;
            var NG1 = document.getElementById('<%=txtGAmt10.ClientID%>').value || 0;

            var TotAvlbl = document.getElementById('<%=AvlblTotBalance.ClientID%>').value;

            var SUMTake = parseFloat(NT2000) + parseFloat(NT1000) + parseFloat(NT500) + parseFloat(NT200) + parseFloat(NT100) + parseFloat(NT50) + parseFloat(NT20) + parseFloat(NT10) + parseFloat(NT5) + parseFloat(NT2) + parseFloat(NT1);// + parseInt(CNS);
            var SUMGive = parseFloat(NG2000) + parseFloat(NG1000) + parseFloat(NG500) + parseFloat(NG200) + parseFloat(NG100) + parseFloat(NG50) + parseFloat(NG20) + parseFloat(NG10) + parseFloat(NG5) + parseFloat(NG2) + parseFloat(NG1);// + parseInt(CNS);

            if (!isNaN(SUMTake) || !isNaN(SUMGive)) {
                document.getElementById('<%=txtTBal.ClientID%>').value = SUMTake;
                document.getElementById('<%=txtGBal.ClientID%>').value = SUMGive;
                document.getElementById('<%=txtBalAvlbl.ClientID%>').value = parseFloat(TotAvlbl) + parseFloat(SUMTake) - parseFloat(SUMGive);
            }
        }
    </script>
  <%--  <script type="text/javascript">
        ...
        function GiveTotal() {
            ...
            var avlbl = document.getElementById('<%=txtBalAvlbl.ClientID%>').value || 0;

            var SUM = parseFloat(NT2000) + parseFloat(NT1000) + parseFloat(NT500) + parseFloat(NT100) + parseFloat(NT50) + parseFloat(NT20) + parseFloat(NT10) + parseFloat(NT5) + parseFloat(NT2) + parseFloat(NT1);// + parseInt(CNS);
            if (!isNaN(SUM)) {
                TakeTotal();
                document.getElementById('<%=txtGBal.ClientID%>').value = SUM;
                document.getElementById('<%=txtBalAvlbl.ClientID%>').value = parseFloat(avlbl) + parseFloat(SUM);
            }
        }
    </script>--%>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-md-2">
                                                   <asp:TextBox ID="txtBalAvlbl" Enabled="false" CssClass="form-control" runat="server" />
                                                    <input type="hidden" id="AvlblTotBalance" runat="server" value="" />
                                                </div>
                                                <div class="col-md-2">
