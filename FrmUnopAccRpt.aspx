<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmUnopAccRpt.aspx.cs" Inherits="FrmUnoperativeAccountReport" %>
                            ...
                            <div class="form-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab1">
                                        ...
                                        <div class="row" id="divmsg" runat="server" visible="false" style="margin: 7px 0 7px 0">
                                            <div class="col-lg-12">
                                                <asp:label id="lblMsg" runat="server" class="control-label col-md-2"></asp:label>
                                            </div>
                                        </div>
                                    ...
                                    <th>
                                        <asp:GridView ID="grdUnOperativeAccts" runat="server" AllowPaging="True" AlternatingRowStyle-CssClass="alt" CssClass="mGrid" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Br Code">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Balance">
                                                    <ItemTemplate>
                                                        <asp:Label ID="BAL" runat="server" Text='<%# Eval("BAL") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
