<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmRView.aspx.cs" Inherits="FrmRView" %>
        ...
        <div>
            ...
            <rsweb:ReportViewer ID="RdlcPrint" runat="server"  Width="100%" Height="100%" ShowBackButton="true" ShowParameterPrompts="true" AsyncRendering="False" SizeToReportContent="True" PageCountMode="Actual" ShowPrintButton="true">
                <LocalReport ReportPath="">
                    <DataSources>
                        <rsweb:ReportDataSource Name="ReportDS" DataSourceId="" />
                        <rsweb:ReportDataSource Name="ReportDS1" DataSourceId="" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
