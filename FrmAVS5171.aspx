<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmAVS5171.aspx.cs" Inherits="FrmAVS5171" %>
            ...
            <div class="panel-body">
                <div class="tab-content">
                    ...
                    <%--<div class="row" style="margin-top: 5px; margin-bottom: 5px;">
                        <div class="col-lg-12">
                            <div class="col-md-2">
                                <label class="control-label ">RecDiv</label>
                            </div>
                            <div class="col-md-1">
                                <asp:TextBox ID="TxtRecDivNo" OnTextChanged="TxtRecDivNo_TextChanged" runat="server" CssClass="form-control" AutoPostBack="true"></asp:TextBox>
                            </div>
                            <div class="col-md-3">
                                <asp:TextBox ID="TxtRecDivName" OnTextChanged="TxtRecDivName_TextChanged" runat="server" CssClass="form-control" AutoPostBack="true"></asp:TextBox>
                                <div id="DivList" style="height: 200px; overflow-y: scroll;"></div>
                                <asp:AutoCompleteExtender ID="AutoRecDivName" runat="server" TargetControlID="TxtRecDivName"
                                    UseContextKey="true"
                                    ...
                                    ServiceMethod="GetRecoveryDiviNames" CompletionListElementID="DivList">
                    ...
                    <div class="row" style="margin-top: 5px; margin-bottom: 5px;" runat="server" id="Div_Reccode">
                        <div class="col-lg-12">
                           <div class="col-md-2">
                            ...
                            <%-- <div class="col-md-2">
                                <asp:TextBox ID="TxtRecDeptNo" OnTextChanged="TxtRecDeptNo_TextChanged" runat="server" CssClass="form-control" AutoPostBack="true"></asp:TextBox>
                            </div>
                            <div class="col-md-4">

                                <asp:TextBox ID="TxtRecDeptName" runat="server" OnTextChanged="TxtRecDeptName_TextChanged" CssClass="form-control" AutoPostBack="true"></asp:TextBox>
                                <div id="DepList" style="height: 200px; overflow-y: scroll;"></div>
                                <asp:AutoCompleteExtender ID="AutoRecDeptName" runat="server" TargetControlID="TxtRecDeptName"
                                    UseContextKey="true"
                                    CompletionInterval="1"
                                    CompletionSetCount="20"
                                    MinimumPrefixLength="1"
                                    EnableCaching="true"
                                    ServicePath="~/WebServices/Contact.asmx"
                                    ServiceMethod="GetRecoveryNames" CompletionListElementID="DepList">
                                </asp:AutoCompleteExtender>
                            </div>--%>
                    ...
                    <%--   <div class="row" style="margin-top: 12px; margin-bottom: 10px;" id="DivType" runat="server" visible="false">
                        <div class="col-lg-12">
                    ...
                    <div class="row" style="margin-top: 5px;">
                        <div class="col-lg-12">
                            ...
                            <div class="col-md-1">
                                ...
                                <asp:CheckBox ID="chkMW" runat="server" />
                            </div>
                            <div class="col-md-1">
                                <label class="control-label ">US</label>
                                <asp:CheckBox ID="chkUS" runat="server" />
                            </div>
                        </div>
                    </div>
