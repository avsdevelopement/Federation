<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmSharesBalRegister.aspx.cs" Inherits="FrmSharesBalRegister" %>
        ...
        <div class="col-md-12">
            <div class="portlet box blue" id="form_wizard_1">
                <div class="portlet-title">
                    <div class="caption">
                        Shares Balance Register Report
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-md-2">
                                                    <asp:RadioButtonList ID="Rdeatils" RepeatDirection="Horizontal" Style="width: 380px;" runat="server">
                                                        <asp:ListItem Text="MemberWise" Value="1" />
                                                        <asp:ListItem Text="BranchWise" Value="2" />
                                                        <asp:ListItem Text="CertWise" Value="3" />
                                                    </asp:RadioButtonList>
                                                </div>
                                            </div>
                                        </div>
