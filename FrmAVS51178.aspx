<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmAVS51178.aspx.cs" Inherits="FrmAVS51178" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function isvalidateForVenMaster() {
            ...
            var Venderno = document.getElementById('<%=txtIssueDate.ClientID%>').value;
            var VenderName = document.getElementById('<%=txtFBrcd.ClientID%>').value;
            var PONO = document.getElementById('<%=txtAmount.ClientID%>').value;
            var ENDTRYDATE = document.getElementById('<%=txtIssueDate.ClientID%>').value;
                                                    ...
                                                    <div class="caption">
                                                        <div class="form-actions">
                                                            ...
                                                            <div style="border: 1px solid #3598dc">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <div class="col-md-12" style="border-bottom: 1px solid rgba(128, 128, 128, 0.31);"><strong style="color: #3598dc">Issue Master Detail's : </strong></div>
                                                                    </div>
                                                                </div>
                                                                <div class="row" style="margin: 7px 0 7px 0">
                                                                    <div class="col-lg-12">
                                                                        <div class="col-md-1">
                                                                            <asp:Label runat="server" Width="120px" Text="FROM BRCD"></asp:Label>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <asp:TextBox ID="txtFBrcd" runat="server" placeholder="From BRCD" Enabled="false" CssClass="form-control" TabIndex="27" onkeypress="javascript:return isNumber (event)"></asp:TextBox>
                                                                        ...
                                                                        <div class=" col-md-2">
                                                                            <asp:TextBox ID="txtBrcdName" runat="server" placeholder="Enetr Brcd Name" Width="250px" AutoPostBack="true" Enabled="false" CssClass="form-control" TabIndex="27"></asp:TextBox>
                                                                ...
                                                                <div class="row" style="margin: 7px 0 7px 0">
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <asp:TextBox ID="txttBRCD" runat="server" placeholder="From BRCD" Enabled="true" CssClass="form-control" AutoPostBack="true" TabIndex="27" OnTextChanged="txttBRCD_TextChanged" onkeypress="javascript:return isNumber (event)"></asp:TextBox>
                                                                        ...
                                                                        <div class=" col-md-2">
                                                                            <asp:TextBox ID="txtTBrcdName" runat="server" Width="250px" placeholder="Enter BRCD Name" AutoPostBack="true" OnTextChanged="txtTBrcd_TextChanged" Enabled="true" CssClass="form-control" TabIndex="27"></asp:TextBox>
                                                                ...
                                                                <div class="row" style="margin: 7px 0 7px 0">
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <asp:TextBox ID="txtIssueId" placeholder="Issue ID" CssClass="form-control" onkeypress="javascript:return isNumber (event)" runat="server" Enabled="false" TabIndex="1"></asp:TextBox>
                                                                        </div>
                                                                        <div class="col-md-1">
                                                                            <asp:Label runat="server" Text="ISSUE DATE" Width="120px"></asp:Label>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <asp:TextBox ID="txtIssueDate" runat="server" onblur="WorkingDate()" placeholder="DD/MM/YYYY" onkeyup="FormatIt(this)" AutoPostBack="true" Enabled="false" CssClass="form-control" TabIndex="2"></asp:TextBox>
                                                                        ...
                                                                        <div id="divInsert" runat="server">
                                                                            <asp:GridView ID="grdInsert" runat="server" AutoGenerateColumns="false" class="noborder fullwidth" Width="100%">
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="VENDORID" ItemStyle-Width="100px" Visible="false">
                                                                                <ItemTemplate>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="VENDOR NAME" ItemStyle-Width="300px" Visible="false">
                                                                                <ItemTemplate>
                                                                                    ...
                                                                                    <tr>
                                                                                        <th>
                                                                                            <asp:GridView ID="GrdIssue" runat="server" CellPadding="6" CellSpacing="7"
                                                                                                ...
                                                                                                PageIndex="15" AutoGenerateColumns="False" CssClass="mGrid" BorderWidth="1px"
                                                                                ...
                                                                                <div id="divNarration" runat="server">
                                                                                    <div id="Div5" class="row" style="margin-top: 5px; margin-bottom: 5px" runat="server">
                                                                                        <div class="col-lg-12">
                                                                                            ...
                                                                                            <div class="col-md-2">
                                                                                                <asp:TextBox ID="TextBox1" Enabled="false" CssClass="form-control" runat="server" />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
