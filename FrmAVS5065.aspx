<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmAVS5065.aspx.cs" Inherits="FrmAVS5065" %>
                                    ...
                                    <div class="tab-pane active" id="tab1">
                                        ...
                                        <div id="dATE" runat="server" class="row" style="margin: 7px 0 7px 0">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-2">
                                                    <asp:TextBox ID="txtFDate" onkeyup="FormatIt(this)" CssClass="form-control" PlaceHolder="DD/MM/YYYY" runat="server" onkeypress="javascript:return isNumber (event) " MaxLength="10"></asp:TextBox>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <asp:TextBox ID="txtTDate" AutoPostBack="true" onkeyup="FormatIt(this)" CssClass="form-control" PlaceHolder="DD/MM/YYYY" runat="server" onkeypress="javascript:return isNumber (event)" MaxLength="10"></asp:TextBox>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <asp:Button ID="btnExit" runat="server" CssClass="btn btn-primary" Text="Exit" OnClick="btnExit_Click1" />
