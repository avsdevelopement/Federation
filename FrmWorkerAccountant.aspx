<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CBSMaster.master" CodeFile="FrmWorkerAccountant.aspx.cs" Inherits="FrmWorkerAccountant" %>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn blue" Text=" कामगार तलाठी नोटीस" OnClick= "btnSubmit_Click" OnClientClick="Javascript:return isvalidate();" />
