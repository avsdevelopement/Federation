...
public partial class FrmInwordCharges : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (ViewState["Flag"].ToString() == "A")
        {
            ...
            string Res = CLM.LOGDETAILS(FL, Session["BRCD"].ToString(), Session["MID"].ToString(), "Inw_Chrg_Add_" + Session["LOGINCODE"].ToString() + "", "00", Session["MID"].ToString());
            ClearData();
        ...
        else if (ViewState["Flag"].ToString() == "ED")
        {
            ...
            BindGrid();
            FL = "Insert";//ankita 14/09/2017
            string Res = CLM.LOGDETAILS(FL, Session["BRCD"].ToString(), Session["MID"].ToString(), "Inw_Chrg_Mod_" + Session["LOGINCODE"].ToString() + "", "00", Session["MID"].ToString());
            ClearData();
        ...
        else if (ViewState["Flag"].ToString() == "D")
        {
            ...
            BindGrid();
            FL = "Insert";//ankita 14/09/2017
            string Res = CLM.LOGDETAILS(FL, Session["BRCD"].ToString(), Session["MID"].ToString(), "Inw_Chrg_Del_" + Session["LOGINCODE"].ToString() + "", "00", Session["MID"].ToString());
            ClearData();
