...
public partial class AVS5022 : System.Web.UI.Page
{
    ...
    protected void Submit_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            string redirectURL = "FrmRView.aspx?FDate=" + TxtFDate.Text + "&TDate=" + TxtTDate.Text + "&UserName=" + Session["UserName"].ToString() + "&BRCD=" + TxtBRCD.Text + "&rptname=Rpt_AVS0004.rdlc";
    ...
    protected void Btn_Exit_Click1(object sender, EventArgs e)
    {
