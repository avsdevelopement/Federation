<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmNPAReport.aspx.cs" Inherits="FrmNPAReport" %>
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                <asp:Button ID="btnReport" runat="server" Text="NPA Register 1" CssClass="btn btn-success" OnClick="btnReport_Click" />
