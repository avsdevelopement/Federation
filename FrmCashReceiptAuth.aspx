<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmCashReceiptAuth.aspx.cs" Inherits="FrmCashReceiptAuth" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-title">
        <h1>Cash Receipt Authorization</h1>
    </div>
