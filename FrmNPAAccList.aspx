<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmNPAAccList.aspx.cs" Inherits="FrmNPAAccList" %>
                ...
                <div class="portlet-body">
                            ...
                            <div class="col-lg-12">
                                <div class="col-md-2">
                                    <asp:RadioButtonList ID="rbtnRptType" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rbtnRptType_SelectedIndexChanged"  AutoPostBack="true">
                                        ...
                                        <asp:ListItem Text="Specific" Value="3" />
                                    </asp:RadioButtonList>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row" style="margin: 7px 0 7px 0">
                        <div class="col-lg-12">
                            ...
                            <div class="col-md-2">
                                <asp:DropDownList ID="DdlSUActivity" runat="server" CssClass="form-control">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="row" id="divtype" runat="server" visible="false" style="margin: 7px 0 7px 0">
                        <div class="col-lg-12">
                            <div class="col-md-2">
                                <label class="control-label ">NPA Type :</label>
                            </div>
                            <div class="col-md-4">
                                <asp:DropDownList ID="ddlNpaTyped" runat="server" CssClass="form-control"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
