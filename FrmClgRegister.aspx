<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmClgRegister.aspx.cs" Inherits="FrmClgRegister" %>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="row" style="margin: 7px 0 7px 0">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <asp:TextBox ID="TxtFDate" onkeyup="FormatIt(this)" onkeypress="javascript:return isNumber (event)" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2">
                                            ...
                                            <div id="div_AccBank" runat="server" visible="false">
                                                <div class="row" style="margin: 7px 0 7px 0"> <%--Dhanya Shetty/12/07/2017--%>
                                                <div class="col-lg-12">
                                                    <div class="col-md-2">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <asp:RadioButton ID="RbtnBank" runat="server" Text="BankWise" OnCheckedChanged="RbtnBank_CheckedChanged" AutoPostBack="true"></asp:RadioButton>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <asp:RadioButton ID="RbnAccount" runat="server" Text="AccountWise" OnCheckedChanged="RbnAccount_CheckedChanged" AutoPostBack="true"></asp:RadioButton>
                                                    </div>
                                                </div>
                                            </div>
                                                </div>
