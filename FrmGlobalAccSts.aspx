<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmGlobalAccSts.aspx.cs" Inherits="FrmGlobalAccSts" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        function isvalidate() {
            ...
            var FDT, TDT, FBR, TBR, FPRD, TPRD, FAC, TAC,
                                        ...
                                        <div class="row" style="margin-bottom: 10px;">
                                            <div class="row" style="margin: 7px 0 7px 0" runat="server" id="CUSTNODIV">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="TxtCustNo" CssClass="form-control" runat="server" onkeypress="javascript:return isNumber (event)" OnTextChanged="TxtCustNo_TextChanged" AutoPostBack="true" TabIndex="3"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <asp:TextBox ID="TxtCustName" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="TxtCustName_TextChanged" TabIndex="4"></asp:TextBox>
                                            ...
                                            <div class="col-lg-12">
                                                <label class="control-label col-md-2">From Dt <span class="required">* </span></label>
                                                <div class="col-md-2">
                                                ...
                                                <label class="control-label col-md-2">To Dt <span class="required">* </span></label>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row" style="margin: 7px 0 7px 0; text-align: center">
                                                <div class="col-lg-12">
                                                    <asp:Button ID="Btn_Calculate" runat="server" Text="Calculate" CssClass="btn btn-primary" />
                                                    <asp:Button ID="Btn_Report" runat="server" Text="Report" CssClass="btn btn-success" />
