<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CBSMaster.master" CodeFile="FrmMainBank.aspx.cs" Inherits="FrmMainBank" %>
                        ...
                        <div class="form-wizard">
                            <div class="form-body">
                                ...
                                <div class="tab-content">
                                    <div id="error">
                                            <div class="col-lg-11">
                                                <label class="control-label col-md-3">Bank code : <span class="required" onkeypress="javascript:return isNumber (event)">* </span></label>
                                                <div class="col-md-3">
                                                    <asp:TextBox ID="txtbankcode" CssClass="form-control" MaxLength="8" Enabled="false" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="tab-pane active" id="tab1">
                                        ...
                                        <div class="row" style="margin: 7px 0 7px 0">
                                            <div class="col-lg-11">
                                                <label class="control-label col-md-2">&nbsp;Zone</label></div>
                                        </div>
                                        ...
                                        <div class="row" style="margin: 7px 0 7px 0">
                                            <div class="col-lg-11">
                                                ...
                                                <div class="col-md-3">
                                                <asp:TextBox ID="txtzone" CssClass="form-control" runat="server" MaxLength="5" AutoPostBack="true" TabIndex="4" onkeypress="javascript:return isNumber (event)" ></asp:TextBox>
                                                </div>
                        ...
                        <tr>
                            <th>
                                <asp:GridView ID="grdBank" runat="server" AllowPaging="True"
                                    ...
                                    PagerStyle-CssClass="pgr" Width="100%" OnSelectedIndexChanged="grdBank_SelectedIndexChanged">
                                    <Columns>

                                           <asp:TemplateField HeaderText="Select" Visible="true">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkSelect" runat="server" OnClick="lnkSelect_Click" Text="select" CommandArgument='<%#Eval("BANKCD")%>' CommandName="select" ></asp:LinkButton>                                                
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                     ...
                                     <asp:TemplateField HeaderText="Delete" Visible="true">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkDelete" runat="server" OnClick="lnkDelete_Click" Text="Delete" CommandArgument='<%#Eval("BANKCD")%>' CommandName="select" ></asp:LinkButton>                                                
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
