...
<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true"CodeFile="FrmInWardReturn.aspx.cs" Inherits="FrmInWordreturn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="page-title">
        <h1>Inward Clearing Pending Authorization</h1>
    </div>
    <div class="row">
        <div class="col-lg-12">
