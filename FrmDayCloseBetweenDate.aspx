<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmDayCloseBetweenDate.aspx.cs" Inherits="FrmDayCloseBetweenDate" %>
        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        Admin's Day Closed Between Date
                    </div>
                </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="Btn_Handover" Text="Branch Handover" runat="server" CssClass="btn btn-primary" OnClick="Btn_Handover_Click" OnClientClick="Javascript:return IsValid();" />
                                        <asp:Button ID="Btn_DayClose" Text="Day Close" runat="server" CssClass="btn btn-primary" Visible="false" OnClick="Btn_DayClose_Click" OnClientClick="Javascript:return IsValid();" />
