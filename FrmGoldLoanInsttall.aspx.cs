...
public partial class FrmGoldLoanInsttall : System.Web.UI.Page
{
    ...
    {
        string redirectURL = "FrmRView.aspx?BRCD=" + txtbranchcode1.Text + "&LOANGL=" + txtloancode1.Text + "&Edate=" + Session["ENTRYDATE"].ToString() + "&ACCNO=" + TXTACCNO.Text + "&rptname=Goldloaninstall.rdlc";
