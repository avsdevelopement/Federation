<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CBSMaster.master" CodeFile="FrmGoldLoanInsttall.aspx.cs" Inherits="FrmGoldLoanInsttall" %>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn blue" Text="Gold Install notice" OnClick=   "btnSubmit_Click" OnClientClick="Javascript:return isvalidate();" />
