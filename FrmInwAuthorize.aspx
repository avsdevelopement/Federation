<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmInwAuthorize.aspx.cs" Inherits="FrmInwAuthorize" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="col-md-12">
            <div class="portlet box blue" id="Div1">
                <div class="portlet-title">
                    <div class="caption">
                        Inward Clg Pending Authorization
                    </div>
                </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab1">
                                        <div class="row" style="margin-bottom: 10px;">
                                            ...
                                            <div class="row" style="margin: 7px 0 7px 0" runat="server" id="Div_Single">
                                                <div class="col-lg-12">
                                                    <label class="control-label col-md-1">Instrument No : </label>
                                                    <div class="col-md-2">
                                            ...
                                            <div class="row" style="margin: 7px 0 7px 0" runat="server" id="Div_Lot" visible="false">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="TxtFSetno" Placeholder="From Setno" onkeypress="javascript:return isNumber (event)" CssClass="form-control" runat="server" AutoPostBack="true"></asp:TextBox>
                                                    </div>
    ...
    <div class="table-scrollable">
        <div class="table-scrollable" style="height: 200px; overflow-x: scroll; overflow-y: scroll; padding-bottom: 10px;">
            <asp:Label ID="Lbl_Rejected" runat="server" Text="REJECTED ENTRIES" BackColor="#66ccff" Font-Bold="true" Font-Size="Medium"></asp:Label>
            <table class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        <th>
                            <asp:GridView ID="Grd_rejected" runat="server" AllowPaging="True" AlternatingRowStyle-CssClass="fa-arrows-alt" EditRowStyle-BackColor="#FFFF99" PagerStyle-CssClass="pgr" OnPageIndexChanging="Grd_rejected_PageIndexChanging" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Select" Visible="true">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LnkSelect" runat="server" CommandArgument='<%#Eval("setscroll")%>' CommandName="select" OnClick="LnkSelect_Click" class="glyphicon glyphicon-edit"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
