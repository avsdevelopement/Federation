...
public partial class FrmTDARenewNCBS2New : System.Web.UI.Page
{
                    ...
                    else
                    {
                        ...
                        if (Result > 0)
                        {
                            ...
                            if (Convert.ToDouble(TxtAmtColl.Text) == (Rdb_Multiple.Checked == false ? Convert.ToDouble(TxtDiff.Text) : Convert.ToDouble(TxtAcPayment.Text)))
                            {
                                ...
                                //Result = RN.InsertEntry("ADD", ViewState["GLC"].ToString(), ViewState["PRD"].ToString(), ViewState["ACC"].ToString(), DrAmt.ToString(), ViewState["CT"].ToString(), "2", ACT, PMTMD, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "EXISTACC", ViewState["REFID"].ToString(), ViewState["RecSrno"].ToString());
                                Result = RN.InsertEntry("ADD", ViewState["GLC"].ToString(), ViewState["PRD"].ToString(), ViewState["ACC"].ToString(), DrAmt.ToString(), ViewState["CT"].ToString(), "2", ACT, PMTMD, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "EXISTACC", ViewState["REFID"].ToString(), ViewState["RecSrno"].ToString(),"0");
                                if (Result > 0)
                                {

                                    Result = RN.InsertEntry("ADD", "10", ViewState["IR"].ToString(), ViewState["ACC"].ToString(), ViewState["INTPAY"].ToString(), ViewState["CT"].ToString(), "2", ACTINT, PMTMODEINT, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "YES", ViewState["REFID"].ToString(), ViewState["RecSrno"].ToString(),"0");
                                   // Result = RN.InsertEntry("ADD", "10", ViewState["IR"].ToString(), ViewState["ACC"].ToString(), ViewState["INTPAY"].ToString(), ViewState["CT"].ToString(), "2", ACTINT, PMTMODEINT, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "YES", ViewState["REFID"].ToString(), ViewState["RecSrno"].ToString());
                                    ...
                                    Result = RN.InsertEntry("ADD", ViewState["GLC"].ToString(), ViewState["PRD"].ToString(), ViewState["ACC"].ToString(), ViewState["INTPAY"].ToString(), ViewState["CT"].ToString(), "1", ACTINT, PMTMODEINT, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "YES", ViewState["REFID"].ToString(), ViewState["RecSrno"].ToString(),"0");
