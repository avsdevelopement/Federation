<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmRecoveryStatement.aspx.cs" Inherits="FrmRecoveryStatement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <div id="page-wrapper">
        ...
        <div class="panel panel-warning">
            <div class="panel-heading">Recovery Report</div>
            <div class="panel-body">
                <div class="tab-content">
                    ...
                    <div class="row" style="margin-top: 12px; margin-bottom: 10px;">
                     ...
                     <div class="row" style="margin-top: 12px; margin-bottom: 10px;">
                        <div class="col-lg-12">
                            <asp:RadioButtonList ID="Rdb_ReportType" runat="server" RepeatDirection="Horizontal" Width="700px">
                                <asp:ListItem Value="S" Text="Recovery to Send" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="P" Text="Recovery for Post"></asp:ListItem>
                                <asp:ListItem Value="A" Text="Recovery after Posting"></asp:ListItem>
                            </asp:RadioButtonList>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 12px; margin-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <div class="col-md-2">
                                <asp:DropDownList ID="ddlBrCode" CssClass="form-control" runat="server" OnSelectedIndexChanged="ddlBrCode_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-1">
