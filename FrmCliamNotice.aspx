<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CBSMaster.master" CodeFile="FrmCliamNotice.aspx.cs" Inherits="FrmCliamNotice" %>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn blue" Text="Cliam Last Notice" OnClick=  "btnSubmit_Click"  OnClientClick="Javascript:return isvalidate();" />
