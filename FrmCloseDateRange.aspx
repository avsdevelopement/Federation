<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmCloseDateRange.aspx.cs" Inherits="FrmCloseDateRange" %>
        ...
        <div class="col-md-12">
            <div class="portlet box blue" id="Div1">
                <div class="portlet-title">
                    <div class="caption">
                        Admin's Day Close Between Date
                    </div>
                </div>
                                    ...
                                    <div class="tab-pane active" id="tab1">
                                        ...
                                        <div class="row" style="margin: 7px 0 7px 0">
                                            <div class="col-lg-12">
                                                ...
                                                <asp:RadioButton ID="rbtnBrHandover" Checked="true" Text="Branch Handover" GroupName="BH" OnCheckedChanged="rbtnBrHandover_CheckedChanged" runat="server" AutoPostBack="true" />
                                        ...
                                        <div class="row" style="margin: 7px 0 7px 0">
                                            <div class="col-lg-12">
                                                ...
                                                <label class="control-label col-md-2">Next Date <span class="required">* </span></label>
                                                <div class="col-md-2">
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="btnHandover" runat="server" CssClass="btn btn-primary" Text="Branch Handover" OnClick="btnHandover_Click" OnClientClick=" Javascript:return IsValid();" />
                                        <asp:Button ID="btnDayClose" Visible="false" runat="server" CssClass="btn btn-primary" Text="Day Close" OnClick="btnDayClose_Click" OnClientClick=" Javascript:return IsValid();" />
