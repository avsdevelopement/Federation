<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmNotice0911.aspx.cs" Inherits="FrmNotice0911" %>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn blue" Text="Notice" OnClick=   "btnSubmit_Click" OnClientClick="Javascript:return isvalidate();" />
