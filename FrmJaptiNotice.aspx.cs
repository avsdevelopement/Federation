...
public partial class FrmJaptiNotice : System.Web.UI.Page
{
    ...
    {
        string redirectURL = "FrmRView.aspx?BRCD=" + txtbranchcode1.Text + "&LOANGL=" + txtloancode1.Text + "&Edate=" + Session["ENTRYDATE"].ToString() + "&ACCNO=" + TXTACCNO.Text + "&rptname=RptJaptiNotice.rdlc";
