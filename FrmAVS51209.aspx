<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmAVS51209.aspx.cs" Inherits="FrmAVS51209" %>
                                              ...
                                              <div class="row" style="margin: 7px 0 7px 0">
                                               ...
                                               <div id="Div5" runat="server" class="row" style="margin: 7px 0 7px 0">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <asp:TextBox ID="txtdefaltername" Placeholder="Defaulter Name" Width="350px" onkeydown="return CheckFirstChar(event.keyCode, this);" onkeypress="javascript:return OnltAlphabets(event)" CssClass="form-control" runat="server" TabIndex="7" AutoPostBack="true"></asp:TextBox>
                                                    </div>
