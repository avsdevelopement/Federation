...
public partial class FrmShareRpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            BD.BindSHRActivtyType(ddlAppType);
    ...
    protected void Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string redirectURL = "FrmRView.aspx?BRCD=" + TxtBrID.Text.Trim().ToString() + "&FDATE=" + TxtFDate.Text.Trim().ToString() + "&TDATE=" + TxtTDate.Text.Trim().ToString() + "&EDATE=" + Session["EntryDate"].ToString() + "&UName=" + Session["UserName"].ToString() + "&ApplType=" + ddlAppType.SelectedValue + "&rptname=RptShareMaster.rdlc";
