<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmAuthorizeCR.aspx.cs" Inherits="FrmAuthorizeCR" %>
        ...
        <div class="col-md-12">
            <div class="portlet box blue" id="form_wizard_1">
                <div class="portlet-title">
                    <div class="caption">
                        Authorize Screen For Cash Receipt
                    </div>
                </div>
                                            ...
                                            <asp:TableRow ID="Tbl_R1" runat="server">
                                                <asp:TableCell ID="Tbl_c1" runat="server" Width="70%" BorderStyle="Solid" BorderWidth="1px">
                                                    ...
                                                    <div class="row" style="margin: 7px 0 7px 0">
                                                        <div class="col-lg-12">
                                                            <div class="col-md-5">
                                                                <asp:RadioButton ID="rbtnNewSet" runat="server" Text="New Voucher" GroupName="Type" Checked="true" />
                                                                <asp:RadioButton ID="rbtnExistSet" runat="server" Text="Existing Voucher" GroupName="Type" />
                                                            </div>
                                                            <div id="DivExistSet" runat="server" visible="false">
                                                                <label class="control-label col-md-2">Set No : </label>
                                                                <div class="col-md-2">
                                                                    <asp:TextBox ID="txtExistSetNo" Enabled="false" CssClass="form-control" runat="server" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
