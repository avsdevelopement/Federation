...
public partial class FrmCashReceiptAuthDo : System.Web.UI.Page
{
    string setno;
    ClsCashReceiptAuthDo CurrentCls = new ClsCashReceiptAuthDo();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        //int ResultInsert = CurrentCls.fundingCash(Session["BRCD"].ToString(), setno.ToString());
