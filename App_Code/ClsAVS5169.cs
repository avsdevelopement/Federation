...
public class ClsAVS5169
{
    ...
    public int delete(string brcd, string pcode, string custno, string accno)
    {
        try
        {
            sql = "Delete from Avs_Acc WHERE BRCD = '" + brcd + "' AND SUBGLCODE = '" + pcode + "' AND CUSTNO = '" + custno + "' AND ACCNO='" + accno + "'";
            Result = conn.sExecuteQuery(sql);
        }
        catch (Exception Ex)
        {
    ...
    public int nomidelete1(string BRCD, string SUBGLCODE, string CUSTNO, string Srno, string ACCNO)
    {
        try
        {
            sql = "delete from NOMINEEDETAILS WHERE BRCD = '" + BRCD + "' AND SUBGLCODE = '" + SUBGLCODE + "' AND CUSTNO = '" + CUSTNO + "' "+
                  "and SRNO='" + Srno + "'  AND ACCNO='" + ACCNO + "' ";
            Result = conn.sExecuteQuery(sql);
        }
        catch (Exception Ex)
        {
    ...
    public int nomidelete2(string BRCD, string SUBGLCODE, string CUSTNO, string Srno, string ACCNO)
    {
        try
        {
            sql = "delete from NOMINEEDETAILS WHERE BRCD = '" + BRCD + "' AND SUBGLCODE = '" + SUBGLCODE + "' AND CUSTNO = '" + CUSTNO + "' "+
    ...
    public int jointdelete1(string BRCD, string SUBGLCODE, string CUSTNO, string Srno, string ACCNO)
    {
        try
        {
            sql = "delete from JOINT  WHERE BRCD = '" + BRCD + "' AND SUBGLCODE = '" + SUBGLCODE + "' AND CUSTNO = '" + CUSTNO + "' "+
                  "and JOINTSRNO='" + Srno + "'  AND ACCNO='" + ACCNO + "' ";
            Result = conn.sExecuteQuery(sql);
        }
        catch (Exception Ex)
        {
    ...
    public int jointdelete2(string BRCD, string SUBGLCODE, string CUSTNO, string Srno, string ACCNO)
    {
        try
        {
            sql = "delete from JOINT  WHERE BRCD = '" + BRCD + "' AND SUBGLCODE = '" + SUBGLCODE + "' AND CUSTNO = '" + CUSTNO + "' "+
    ...
    public int jointautho1(string BRCD, string SUBGLCODE, string CUSTNO, string Srno, string ACCNO, string mid)
    {
        try
        {
