...
<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmInWordreturnAuth.aspx.cs" Inherits="FrmInWordreturnAuth" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-title">
        <h1>Inword Clearing Pending Authorization</h1>
    </div>
    <div class="row">
        <div class="col-lg-12">
