...
public partial class FrmTDARenewN : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ViewState["MS"].ToString() == "N")
            {
                ...
                ViewState["PrdName"] = Convert.ToString(Request.QueryString["PrdName"]);
                ...
                ViewState["IntType"] = Convert.ToString(Request.QueryString["IntType"]);
                ...
                Res = RN.DeleteData("DELETE", Session["MID"].ToString(), Session["BRCD"].ToString(), Session["EntryDate"].ToString());
    ...
    protected void Rdb_PrinWithInt_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            int Res = RN.DeleteData("DELETE", Session["MID"].ToString(), Session["BRCD"].ToString(), Session["EntryDate"].ToString());
    ...
    protected void Rdb_OnlyPrin_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (ViewState["MS"].ToString() == "N")
        {
            ...
            if (Convert.ToDouble(ViewState["INTPAY"].ToString()) < (MAMT - DAMT))
                ...
                if (ViewState["MS"].ToString() == "N")
                {
                    if (Rdb_WithReceipt.Checked != true)
                    {
                        ...
                        if (Rdb_OnlyPrin.Checked == true)
                        {
                            ...
                            TxtProcode.Text = Convert.ToString(ViewState["PRD"]);
                            TxtPrdName.Text = Convert.ToString(ViewState["PrdName"]);
                        }
                        else
                        {
    ...
    private void GetTotalAmount()
    {
        ...
        {
            string RT = "";
            string RR = CurrentCls.GetInterestRateED("TDA", "", TxtProcode.Text, ViewState["ACCTYPE"].ToString(), Ddl_PerioDtype.SelectedValue.ToString(), TxtPeriod.Text, TxtDepositDate.Text, true);
            // string RR = FDR.Getrate(TxtPeriod.Text, TxtProcode.Text, Ddl_PerioDtype.SelectedValue, ViewState["ACCTYPE"].ToString(), Session["BRCD"].ToString(),TxtDepositDate.Text);
            if (RR != null)
            {
                TxtRate.Text = RR;
                RT = TxtRate.Text;
    ...
    protected void Btn_SubmitWr_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["MS"].ToString() == "N") // For Single Clsoure 
            {
                ...
                if (Rdb_WithReceipt.Checked != true)
                {
                    Result = RN.InsertEntry("ADD", "10", ViewState["IR"].ToString(), ViewState["ACC"].ToString(), TxtWrAmount.Text, "0", "2", ACTINT, PMTMODEINT, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "INTYES", ViewState["REFID"].ToString(), ChqNo);
                   if (Result > 0)
                    {

                        Result = RN.InsertEntry("ADD", ViewState["CRGL"].ToString(), TxtWrPrdcode.Text, TxtWrAccno.Text, TxtWrAmount.Text, "0", "1", ACT, PMTMD, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "INTYES", ViewState["REFID"].ToString(), ChqNo);
                        if (Result > 0)
                        {
                ...
                else
                {
                    ...
                    Result = RN.InsertEntry("ADD", ViewState["CRGL"].ToString(), TxtWrPrdcode.Text, TxtWrAccno.Text, TxtWrAmount.Text, "0", "2", ACT, PMTMD, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "WITHREC", ViewState["REFID"].ToString());
                    if (Result > 0)
                    {
            ...
            else
            {
                if (Rdb_WithReceipt.Checked != true)
                {
                    Result = RN.InsertEntry("ADD", ViewState["GLNetPaid"].ToString(), ViewState["NetPaid"].ToString(), "0", TxtWrAmount.Text, ViewState["CT"].ToString(), "2", ACT, PMTMD, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "INTYES", ViewState["REFID"].ToString());
                    if (Result > 0)
                    {

                        Result = RN.InsertEntry("ADD", ViewState["CRGL"].ToString(), TxtWrPrdcode.Text, TxtWrAccno.Text, TxtWrAmount.Text, "0", "1", ACT, PMTMD, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "INTYES", ViewState["REFID"].ToString());
                        if (Result > 0)
                        {
                            ViewState["InterestCredited"] = TxtWrAmount.Text;
                ...
                else
                {
                    ...
                    Result = RN.InsertEntry("ADD", ViewState["GLNetPaid"].ToString(), ViewState["NetPaid"].ToString(), "0", TxtWrAmount.Text, ViewState["CT"].ToString(), "1", ACT, PMTMD, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "WITHREC", ViewState["REFID"].ToString());
                    ...
                    else
                    {
                        ...
                        if (Result > 0)
                        {
                            ...
                            if (Convert.ToDouble(TxtAmtColl.Text) == (Rdb_Multiple.Checked == false ? Convert.ToDouble(TxtDiff.Text) : Convert.ToDouble(TxtAcPayment.Text)))
                            {
                                ...
                                Result = RN.InsertEntry("ADD", ViewState["GLC"].ToString(), ViewState["PRD"].ToString(), ViewState["ACC"].ToString(), DrAmt.ToString(), ViewState["CT"].ToString(), "2", ACT, PMTMD, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "EXISTACC", ViewState["REFID"].ToString());
                                if (Result > 0)
                                {

                                    Result = RN.InsertEntry("ADD", "10", ViewState["IR"].ToString(), ViewState["ACC"].ToString(), ViewState["INTPAY"].ToString(), ViewState["CT"].ToString(), "2", ACT, "TR", Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "YES", ViewState["REFID"].ToString());
                    ...
                    else
                    {
                        ...
                        if (Result > 0)
                        {
                            ...
                            if (Convert.ToDouble(TxtAmtColl.Text) == Convert.ToDouble(TxtDiff.Text))
                            {
                                ...
                                Result = RN.InsertEntry("ADD", ViewState["GLC"].ToString(), ViewState["PRD"].ToString(), ViewState["ACC"].ToString(), ExistingFDAmt.ToString(), ViewState["CT"].ToString(), "2", ACT, PMTMD, Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "EXISTACC", ViewState["REFID"].ToString());
                                if (Result > 0)
                                {
               ...
               //Not changed on 29-11-2017 not to credit interest in 5 -Abhishek
                ...
                else if (ViewState["MS"].ToString() == "Y" && Rdb_PrinWithInt.Checked == false && Rdb_WithReceipt.Checked == false)
                {
                    ...
                    else
                    {
                        ...
                        Result = RN.InsertEntry("ADD", ViewState["GLNetPaid"].ToString(), ViewState["NetPaid"].ToString(), "0", TxtDepoAmt.Text, ViewState["CT"].ToString(), "2", "7", "TR", Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "YES", ViewState["REFID"].ToString());
                ...
                else if (ViewState["MS"].ToString() == "Y" && Rdb_WithReceipt.Checked == true)
                {
                    ...
                    else
                    {
                        ...
                        Result = RN.InsertEntry("ADD", ViewState["GLNetPaid"].ToString(), ViewState["NetPaid"].ToString(), "0", Amt.ToString(), ViewState["CT"].ToString(), "2", "7", "TR", Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "YES", ViewState["REFID"].ToString());
                    ...
                    else
                    {
                        ...
                        if (Result > 0)
                        {
                            ...
                            if (Convert.ToDouble(TxtAmtColl.Text) == Convert.ToDouble(TxtDiff.Text))
                            {
                              ...
                              //  string ExistingFDAmt = (Convert.ToDouble(TxtAcPayment.Text) - Convert.ToDouble(ViewState["InterestCredited"].ToString())).ToString();
                                string ExistingFDAmt = (Convert.ToDouble(TxtAcPayment.Text)).ToString();
                                ...
                                if (Result > 0)
                                {
                                  ...
                                  // Result = RN.InsertEntry("ADD", "10", ViewState["IR"].ToString(), ViewState["ACC"].ToString(), ViewState["INTPAY"].ToString(), ViewState["CT"].ToString(), "2", ACT, "TR-INT", Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "YES", ViewState["REFID"].ToString());
                                    ...
                                    Result = RN.InsertEntry("ADD", ViewState["GLC"].ToString(), ViewState["PRD"].ToString(), ViewState["ACC"].ToString(), ViewState["InterestCredited"].ToString(), ViewState["CT"].ToString(), "1", "10", "TR-INT", Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "YES", ViewState["REFID"].ToString());
    ...
    protected void Btn_PostEntry_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string RES = RN.PostSingle("POST", RType, Session["MID"].ToString(), Session["EntryDate"].ToString(), Session["BRCD"].ToString());
            if (RES != null)
            {
    ...
    protected void CalculatedepositINT(float amt, string subgl, float intrate, int Period, string intpay, string PTYPE)
    {
        try
        {
            ...
            {
                case "PLKP":
                    DT = CurrentCls.TDACase("PLKP", Session["EntryDate"].ToString(), TxtPeriod.Text, TxtDepoAmt.Text, TxtProcode.Text, Ddl_PerioDtype.SelectedValue);
                    if (DT.Rows.Count > 0)
                    {
                        //MatAmt	IntAmt
                    ...
                    break;
                case "MISLT":
                    DT = CurrentCls.TDACase("MISLT", Session["EntryDate"].ToString(), TxtPeriod.Text, TxtDepoAmt.Text, TxtProcode.Text, Ddl_PerioDtype.SelectedValue);
                    if (DT.Rows.Count > 0)
                    {
                        //MatAmt	IntAmt
                        TxtMaturity.Text = DT.Rows[0]["MatAmt"].ToString();
    ...
    public void InsertNetPaid(string Amount)
    {
        try
        {
            Result = RN.InsertEntry("ADD", ViewState["GLNetPaid"].ToString(), ViewState["NetPaid"].ToString(), "0", Amount.ToString(), ViewState["CT"].ToString(), "1", "7", "TR", Session["BRCD"].ToString(), Session["MID"].ToString(), Session["EntryDate"].ToString(), "YES", ViewState["REFID"].ToString());
        }
        catch (Exception Ex)
        {
            ExceptionLogging.SendErrorToText(Ex);
                ...
                if (ViewState["MS"].ToString() == "N")
                {
                    if (Rdb_WithReceipt.Checked != true)
                    {
                        ...
                        if (Rdb_OnlyPrin.Checked == true)
                        {
                            ...
                            TxtProcode.Text = Convert.ToString(ViewState["PRD"]);
                            TxtPrdName.Text = Convert.ToString(ViewState["PrdName"]);
                            Ddl_IntPayout.SelectedValue = Convert.ToString(ViewState["IntType"]);


                            TxtPeriod.Text = Convert.ToString(ViewState["Period"]);
                            GetTotalAmount();
