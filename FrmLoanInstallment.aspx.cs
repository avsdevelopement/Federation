...
public partial class FrmLoanInstallment : System.Web.UI.Page
{
    ...
    string sResult = "", RefNumber, PmtMode, FL = "";
    ...
    protected void GetLoanData()
    {
        ...
        try
        {
            ...
            if (DT.Rows.Count > 0)
            {
                ...
                txtMobileNo1.Text = Convert.ToString(DT.Rows[0]["Mobile1"]);
                txtMobileNo2.Text = Convert.ToString(DT.Rows[0]["Mobile2"]);
                ...
                WorkDate.Value = DT.Rows[0]["WorkingDate"].ToString();
                ...
                if (Convert.ToInt32(AccStatus.Value.ToString()) != 3)
                {
                    ...
                    if (DT.Rows.Count > 0)
                    {
                        ...
                        //Claculate Interest
                        txtIntPrev.Text = Convert.ToDouble(DT.Rows[0]["Interest"].ToString() == "" ? "0" : DT.Rows[0]["Interest"].ToString()).ToString();
                        if (IntApp == 1)
                        {
                            if (ViewState["LNCAT"].ToString() == "LNSTF")
                            {
                                if (Math.Abs(PrincipleAmt < 0 ? 0 : PrincipleAmt) > 250000)
                                {
                                    double PrinBal = Convert.ToDouble(Math.Abs(PrincipleAmt < 0 ? 0 : PrincipleAmt) - 250000);
                                    double Interest = Math.Round(Convert.ToDouble((250000 * Convert.ToDouble(txtIntRate.Text.Trim().ToString() == "" ? "0" : txtIntRate.Text.Trim().ToString())) * Convert.ToInt32(txtDays.Text.Trim().ToString()) / 36500));
                                    Interest = Convert.ToDouble(Interest + Math.Round(Convert.ToDouble((PrinBal * 10.50) * Convert.ToInt32(txtDays.Text.Trim().ToString()) / 36500)));
                                    txtIntCurr.Text = Interest.ToString("#.##");
                                }
                                else
                                {
                        ...
                        if (DrawPower != null && DrawPower != "")
                        {
                            ...
                            {
                                txtTotOverdue.Text = Math.Round(Math.Abs(PrincipleAmt < 0 ? 0 : PrincipleAmt)).ToString();
                            }
                        ...
                        txtIntRecPrev.Text = Convert.ToDouble(DT.Rows[0]["InterestRec"].ToString() == "" ? "0" : DT.Rows[0]["InterestRec"].ToString()).ToString();
                        ...
                        txtPIntPrev.Text = DT.Rows[0]["PInterest"].ToString();
                        txtPIntCurr.Text = "";
                        ...
                        else if (PenalType.ToString() == "N")
                        {
                            ...
                            else
                            {
                                if (IntApp == 1)
                                {
                                    if (Convert.ToDouble(txtTotOverdue.Text.Trim().ToString() == "" ? "0" : txtTotOverdue.Text.Trim().ToString()) > 0)
                                    {
                        ...
                        txtNotChrgPrev.Text = DT.Rows[0]["NoticeChrg"].ToString();
                        ...
                        txtSerChrgPrev.Text = DT.Rows[0]["ServiceChrg"].ToString();
                        ...
                        txtCrtChrgPrev.Text = DT.Rows[0]["CourtChrg"].ToString();
                        ...
                        txtOtherChrgPrev.Text = DT.Rows[0]["OtherChrg"].ToString();
                        ...
                        txtBankChrgPrev.Text = DT.Rows[0]["BankChrg"].ToString();
                        ...
                        txtInsurancePrev.Text = DT.Rows[0]["InsChrg"].ToString();
                        ...
                        txtSurChrgPrev.Text = DT.Rows[0]["SurChrg"].ToString();
    ...
    public void AmountLock(bool Lock)
    {
        try
        {
            txtIntCurr.Enabled = Lock;
            txtPIntCurr.Enabled = Lock;
            txtIntRecCurr.Enabled = Lock;
            txtNotChrgCurr.Enabled = Lock;
            txtSerChrgCurr.Enabled = Lock;
            txtCrtChrgCurr.Enabled = Lock;
            txtSurChrgCurr.Enabled = Lock;
            txtOtherChrgCurr.Enabled = Lock;
            txtBankChrgCurr.Enabled = Lock;
            txtInsuranceCurr.Enabled = Lock;
            txtPrinAmt.Enabled = Lock;
            txtIntAmt.Enabled = Lock;
            txtPIntAmt.Enabled = Lock;
            txtIntRecAmt.Enabled = Lock;
            txtNotChrgAmt.Enabled = Lock;
            txtSerChrgAmt.Enabled = Lock;
            txtCrtChrgAmt.Enabled = Lock;
            txtSurChrgAmt.Enabled = Lock;
            txtOtherChrgAmt.Enabled = Lock;
            txtBankChrgAmt.Enabled = Lock;
            txtInsuranceAmt.Enabled = Lock;
        }
        catch (Exception Ex)
        {
            ExceptionLogging.SendErrorToText(Ex);
        ...
        try
        {
            ...
            if (sResult != null)
            {
                ...
                else
                {
                    ...
                    dtmodal = CR.GetInfoTbl(Session["BRCD"].ToString(), Session["ENTRYDATE"].ToString(), txtAccNo.Text.Trim().ToString(), txtProdType.Text.Trim().ToString());
                    if (dtmodal.Rows.Count > 0)
                    {
                        resultout = CR.GetInfo(GrdView, Session["BRCD"].ToString(), Session["ENTRYDATE"].ToString(), txtAccNo.Text.Trim().ToString(), txtProdType.Text.Trim().ToString());
                        if (resultout > 0)
                        {
    ...
    protected void ddlPayType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else if (ddlPayType.SelectedValue.ToString() == "1")
        {
            ...
            txtAmount.Text = txtTotPaidAmt.Text.Trim().ToString() == "" ? "0" : txtTotPaidAmt.Text.Trim().ToString();
            Clear();
            btnSubmit.Focus();
        }
        ...
        try
        {
            ...
            if (Convert.ToDouble(txtDepositeAmt.Text.Trim().ToString()) > 0)
            {
                if (AccStatus.Value.ToString() != "9")
                {
                    ...
                    if (LI.CheckStaff(Session["BRCD"].ToString(), txtProdType.Text.Trim().ToString()) == "LNSTF")
                    {
                        ...
                        if (Convert.ToDouble(txtPrinTotal.Text.Trim().ToString() == "" ? "0" : txtPrinTotal.Text.Trim().ToString()) > 0)
                        {
                            ...
                            txtPrinPen.Text = Math.Round(Convert.ToDouble(Convert.ToDouble(txtPrinTotal.Text) - Convert.ToDouble(txtPrinAmt.Text)), 2).ToString();
                        }
                        else
                        {
                ...
                else if (AccStatus.Value.ToString() == "9")
                {
                    ClearTotAmt();
                    DepAmount = Convert.ToDouble(Convert.ToDouble(txtDepositeAmt.Text.Trim().ToString()));

                    //Calculate Received Interest
                    if (Convert.ToDouble(txtIntRecTotal.Text.Trim().ToString() == "" ? "0" : txtIntRecTotal.Text.Trim().ToString()) > 0)
                    {
                        if (DepAmount >= Convert.ToDouble(txtIntRecTotal.Text.Trim().ToString() == "" ? "0" : txtIntRecTotal.Text.Trim().ToString()))
                        {
                    ...
                    //Calculate Penal Interest Charge
                    if (Convert.ToDouble(txtPIntTotal.Text.Trim().ToString() == "" ? "0" : txtPIntTotal.Text.Trim().ToString()) > 0)
                    {
                        if (DepAmount >= Convert.ToDouble(txtPIntTotal.Text.Trim().ToString() == "" ? "0" : txtPIntTotal.Text.Trim().ToString()))
                        {
                    ...
                    //  Current surcharge calculation
                    TotalAmt = Math.Round(Convert.ToDouble(Convert.ToDouble(txtIntRecAmt.Text.ToString() == "" ? "0" : txtIntRecAmt.Text.ToString()) + Convert.ToDouble(txtIntAmt.Text.ToString() == "" ? "0" : txtIntAmt.Text.ToString()) + Convert.ToDouble(txtPrinAmt.Text.ToString() == "" ? "0" : txtPrinAmt.Text.ToString())));
                    SurIntRate = LI.GetSurIntRate(AccType.Value.ToString());
                    if (Convert.ToDouble(txtDepositeAmt.Text.Trim().ToString()) == Convert.ToDouble(txtTotalAmt.Text.Trim().ToString()))
                    {
                        txtSurChrgCurr.Text = Math.Abs(Math.Round(Convert.ToDouble(Convert.ToDouble(TotalAmt * SurIntRate) / 100))).ToString();
                        txtSurChrgTotal.Text = Math.Round(Convert.ToDouble(txtSurChrgPrev.Text.Trim().ToString()) + Convert.ToDouble(txtSurChrgCurr.Text.Trim().ToString() == "" ? "0" : txtSurChrgCurr.Text.Trim().ToString())).ToString();
                    }
                    ...
                    {
                        txtSurChrgCurr.Text = Math.Abs(Math.Round(Convert.ToDouble(TotalAmt / (SurIntRate + 100) * 100) - TotalAmt)).ToString();
                        txtSurChrgTotal.Text = Math.Round(Convert.ToDouble(txtSurChrgPrev.Text.Trim().ToString()) + Convert.ToDouble(txtSurChrgCurr.Text.Trim().ToString() == "" ? "0" : txtSurChrgCurr.Text.Trim().ToString())).ToString();
                    }
                ...
                //  Pending Amount transfer to loan account (Principle Amount)
                if (ViewState["LNCAT"].ToString() == "CCOD")
                {
                    if (DepAmount > 0)
                    {
                        txtPrinAmt.Text = (Convert.ToDouble(txtPrinAmt.Text.ToString() == "" ? "0" : txtPrinAmt.Text.ToString()) + DepAmount).ToString();
                        txtPrinPen.Text = Convert.ToDouble(Convert.ToDouble(txtPrinTotal.Text.ToString() == "" ? "0" : txtPrinTotal.Text.ToString()) - Convert.ToDouble(txtPrinAmt.Text.ToString() == "" ? "0" : txtPrinAmt.Text.ToString())).ToString();
                    }
                }
    ...
    #region For Denomination Purpose

    protected void BtnViewCoBorrow_Click(object sender, EventArgs e)
    {
        try
        {
            resmodal = LI.GetBorrower(grdcoborrower, Session["BRCD"].ToString(), txtAccNo.Text, txtProdType.Text);
            if (resmodal > 0)
            {
                string Modal_Flag = "COBORROWER";
                System.Text.StringBuilder sb = new System.Text.StringBuilder();
            ...
            {
                WebMsgBox.Show("There is no borrower name for account no." + txtAccNo.Text, this.Page);
            }
        }
        catch (Exception ex)
        {
    ...
    public void BindGrid1()
    {
        try
        {
            CurrentCls.Getinfotable(grdCashRct, Session["MID"].ToString(), Session["BRCD"].ToString(), Session["EntryDate"].ToString(), "LOANINST");
        }
        catch (Exception Ex)
        {
            ExceptionLogging.SendErrorToText(Ex);
    ...
    protected void grdCashRct_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (ViewState["CHECK_FLAG"].ToString() == "PRINT")
            {
                ...
                FL = "Insert";
                string Res = CLM.LOGDETAILS(FL, Session["BRCD"].ToString(), Session["MID"].ToString(), "Loan_Paid _Print_" + txtProdType.Text + "_" + txtAccNo.Text + "_" + txtDepositeAmt.Text + "_" + Session["LOGINCODE"].ToString() + "", "00", Session["MID"].ToString());
                ...
                if (CheckInterest() == true)
                {
                    if (CheckPenal() == true)
                    {
                        if (btnSubmit.Visible == true)
                        {
                            if (Convert.ToDouble(txtDepositeAmt.Text.Trim().ToString() == "" ? "0" : txtDepositeAmt.Text.Trim().ToString()) == Convert.ToDouble(txtTotPaidAmt.Text.Trim().ToString() == "" ? "0" : txtTotPaidAmt.Text.Trim().ToString())) 
                            {
                                ...
                                if (IntCalType == 1 || IntCalType == 2)
                                {
                                    if (ddlPayType.SelectedValue.ToString() == "1")
                                    {
                                        ...
                                        resultint = ITrans.Authorized(Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), "99", "99", txtAccNo.Text.Trim().ToString(),
                                                    txtNarration.Text, "PAYDR", Convert.ToDouble(txtTotPaidAmt.Text.Trim().ToString() == "" ? "0" : txtTotPaidAmt.Text.Trim().ToString()), "2", Activity.ToString(), PmtMode.ToString(), SetNo, "0", "01/01/1900", "0", "0", "1001",
                                                    "", Session["BRCD"].ToString(), Session["MID"].ToString(), txtProdType.Text.Trim().ToString() + "/" + txtAccNo.Text.Trim().ToString(), "0", "LOANINST", txtCustNo.Text.Trim().ToString(), txtAccName.Text.ToString(), ViewState["RID"].ToString());
                                    }
                                    //Amol
                                    else if (ddlPayType.SelectedValue.ToString() == "2")
                                    {
                                        ...
                                        resultint = ITrans.Authorized(Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), ViewState["GLCODE1"].ToString(), txtProdType1.Text.Trim().ToString(),
                                                    TxtAccNo1.Text.Trim().ToString(), txtNarration.Text, "PAYDR", Convert.ToDouble(txtTotPaidAmt.Text.Trim().ToString() == "" ? "0" : txtTotPaidAmt.Text.Trim().ToString()), "2", Activity.ToString(), PmtMode.ToString(), SetNo, "0", "01/01/1900", "0", "0", "1001",
                                                    "", Session["BRCD"].ToString(), Session["MID"].ToString(), txtProdType.Text.Trim().ToString() + "/" + txtAccNo.Text.Trim().ToString(), "0", "LOANINST", txtCustNo.Text.Trim().ToString(), txtAccName.Text.ToString(), ViewState["RID"].ToString());
                                    }
                                    //Amol
                                    else if (ddlPayType.SelectedValue.ToString() == "4")
                                        ...
                                        if (resultint > 0)
                                        {
                                            ...
                                            else if (IntCalType == 2)
                                            {
                                                if (Convert.ToDouble(txtIntAmt.Text.Trim().ToString() == "" ? "0" : txtIntAmt.Text.Trim().ToString()) > 0)
                                                {
                                                    ...
                                                    resultint = ITrans.Authorized(Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), ViewState["PrincipleGl"].ToString(), ViewState["PrincipleSub"].ToString(),
                                                                txtAccNo.Text.ToString(), txtNarration.Text, "INTCR", Convert.ToDouble(txtIntAmt.Text.Trim().ToString()), "1", Activity.ToString(), PmtMode.ToString(), SetNo, CN, CD, "0", "0", "1001",
                                                                "", Session["BRCD"].ToString(), Session["MID"].ToString(), "0", "0", "LOANINST", txtCustNo.Text.Trim().ToString(), txtAccName.Text.ToString(), ViewState["RID"].ToString());
                                                }
                                        ...
                                        if (resultint > 0)
                                        {
                                            if (Convert.ToDouble(txtPIntAmt.Text.Trim().ToString() == "" ? "0" : txtPIntAmt.Text.Trim().ToString()) > 0)
                                            {
                                                ...
                                                resultint = ITrans.Authorized(Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), ViewState["PInterestGl"].ToString(), ViewState["PInterestSub"].ToString(),
                                                            txtAccNo.Text.ToString(), txtNarration.Text, "PENCR", Convert.ToDouble(txtPIntAmt.Text.Trim().ToString()), "1", Activity.ToString(), PmtMode.ToString(), SetNo, CN, CD, "0", "0", "1001",
                                                            "", Session["BRCD"].ToString(), Session["MID"].ToString(), "0", "0", "LOANINST", txtCustNo.Text.Trim().ToString(), txtAccName.Text.ToString(), ViewState["RID"].ToString());
                                            }
                                ...
                                if (IntCalType == 3)
                                {
                                    ...
                                    if (resultint > 0)
                                    {
                                        ...
                                        resultint = ITrans.Authorized(Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), ViewState["PrincipleGl"].ToString(), ViewState["PrincipleSub"].ToString(),
                                                    txtAccNo.Text.ToString(), txtNarration.Text, "PAYDR", TotalAmt, "2", Activity.ToString(), PmtMode.ToString(), SetNo1.ToString(), "0", "01/01/1900", "0", "0", "1003",
                                                    "", Session["BRCD"].ToString(), Session["MID"].ToString(), txtProdType.Text.Trim().ToString() + "/" + txtAccNo.Text.Trim().ToString(), "0", "LOANINST", txtCustNo.Text.Trim().ToString(), txtAccName.Text.ToString(), ViewState["RID"].ToString());
                                        ...
                                        if (resultint > 0)
                                        {
                                            if (Convert.ToDouble(txtIntAmt.Text.Trim().ToString() == "" ? "0" : txtIntAmt.Text.Trim().ToString()) > 0)
                                            {
                                                //interest Received Credit to GL 11
                                                resultint = ITrans.Authorized(Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), ViewState["InterestGl"].ToString(), ViewState["InterestSub"].ToString(),
                                                            txtAccNo.Text.ToString(), txtNarration.Text, "INTCR", Convert.ToDouble(txtIntAmt.Text.Trim().ToString()), "1", Activity.ToString(), PmtMode.ToString(), SetNo1.ToString(), "0", "01/01/1900", "0", "0", "1003",
                                                            "", Session["BRCD"].ToString(), Session["MID"].ToString(), "0", "0", "LOANINST", txtCustNo.Text.Trim().ToString(), txtAccName.Text.ToString(), ViewState["RID"].ToString());
                                            }
                                            ...
                                            if (resultint > 0)
                                            {
                                                if (Convert.ToDouble(txtPIntAmt.Text.Trim().ToString() == "" ? "0" : txtPIntAmt.Text.Trim().ToString()) > 0)
                                                {
                                                    //Penal Charge Credit To GL 12
                                                    resultint = ITrans.Authorized(Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), Session["EntryDate"].ToString(), ViewState["PInterestGl"].ToString(), ViewState["PInterestSub"].ToString(),
                                                                txtAccNo.Text.ToString(), txtNarration.Text, "PENCR", Convert.ToDouble(txtPIntAmt.Text.Trim().ToString()), "1", Activity.ToString(), PmtMode.ToString(), SetNo1.ToString(), "0", "01/01/1900", "0", "0", "1003",
                                                                "", Session["BRCD"].ToString(), Session["MID"].ToString(), "0", "0", "LOANINST", txtCustNo.Text.Trim().ToString(), txtAccName.Text.ToString(), ViewState["RID"].ToString());
                                                }
                                ...
                                if (resultint > 0)
                                {
                                    if (Convert.ToDouble(txtTotPendAmt.Text.Trim().ToString() == "" ? "0" : txtTotPendAmt.Text.Trim().ToString()) == 0)
                                    {
                                        ...
                                        {
                                            FL = "Insert";
                                            string Res = CLM.LOGDETAILS(FL, Session["BRCD"].ToString(), Session["MID"].ToString(), "Loan_Close _" + txtProdType.Text + "_" + txtAccNo.Text + "_" + txtDepositeAmt.Text + "_" + Session["LOGINCODE"].ToString() + "", "00", Session["MID"].ToString());

                                            WebMsgBox.Show("Successfully Loan Account Close With SetNo : " + Convert.ToInt32(SetNo), this.Page);
                                            BindGrid1();
                                            ClearAll();
                                            txtProdType.Focus();
                                            return;
                                    ...
                                    {
                                        if ((Convert.ToDouble(Session["IntApp"].ToString()) == 1) || (Convert.ToDouble(Session["IntApp"].ToString()) == 4))
                                        {
                                            resultint = LI.UpdateLastIntDate(Session["BRCD"].ToString(), txtProdType.Text, txtAccNo.Text, WorkDate.Value.ToString(), Session["MID"].ToString());

                                            if (resultint > 0)
                                            {
                                                FL = "Insert";
                                                string Res = CLM.LOGDETAILS(FL, Session["BRCD"].ToString(), Session["MID"].ToString(), "Loan_Paid _" + txtProdType.Text + "_" + txtAccNo.Text + "_" + txtDepositeAmt.Text + "_" + Session["LOGINCODE"].ToString() + "", "00", Session["MID"].ToString());

                                                WebMsgBox.Show("Successfully Paid With SetNo : " + Convert.ToInt32(SetNo), this.Page);
                                                BindGrid1();
                                                ClearAll();
                                                txtProdType.Focus();
                                                return;
                            ...
                            {
                                WebMsgBox.Show("Excess amount of receipt ...!!", this.Page);
                                return;
                            }
                        }
                        else
    ...
    protected void Btn_Loan_Sch_Click(object sender, EventArgs e)
    {
        ...
        {
            FL = "Insert";
            string Res = CLM.LOGDETAILS(FL, Session["BRCD"].ToString(), Session["MID"].ToString(), "Loan_Schedule_rpt _" + txtProdType.Text + "_" + txtAccNo.Text + "_" + Session["LOGINCODE"].ToString() + "", "00", Session["MID"].ToString());
    ...
    protected void btnAccStat_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            FL = "Insert";
            string Res = CLM.LOGDETAILS(FL, Session["BRCD"].ToString(), Session["MID"].ToString(), "Loan_Acc_Statmnt _" + txtProdType.Text + "_" + txtAccNo.Text + "_" + txtDepositeAmt.Text + "_" + Session["LOGINCODE"].ToString() + "", "00", Session["MID"].ToString());
