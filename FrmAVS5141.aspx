<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmAVS5141.aspx.cs" Inherits="FrmAVS5141" %>
                ...
                <div class="table-scrollable" style="width: 100%; height: 350px; overflow-x: auto; overflow-y: auto">
                    <table class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>
                                   <%-- <asp:Label ID="GrdCerti" runat="server" Text="Preview Sanchit Certificate"></asp:Label>
