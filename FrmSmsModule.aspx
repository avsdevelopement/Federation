<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmSmsModule.aspx.cs" Inherits="FrmSmsModule" %>
                                            ...
                                            <div class="tab-pane active" id="tab1">
                                                ...
                                                <div class="panel-group" id="accordion">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                <a data-toggle="collapse" id="FirstDiv" data-parent="#accordion" href="#collapse1" onclick="SetFirstHiddenID(1);">Normal Message</a>
                                                            </h4>
                                                        </div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="row" style="margin: 7px 0 7px 0">
                                                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <asp:DropDownList ID="ddlCustType" runat="server" CssClass="form-control" OnTextChanged="ddlCustType_TextChanged" AutoPostBack="true">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <asp:TextBox ID="txtFromCustNo" CssClass="form-control" runat="server" placeholder=" Account Number" OnTextChanged="txtFromCustNo_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                                            </div>
                                                        ...
                                                        <asp:RadioButton ID="rdbSMSEng" GroupName="RdbSMSGrp" runat="server" Text="English" Checked="true" AutoPostBack="true" OnCheckedChanged="rdbSMSEng_CheckedChanged" />
                                                                    ...
                                                                    <div class="row" style="margin: 7px 0 7px 0">
                                                                        <div class="col-md-offset-2 col-md-8">
                                                                            ...
                                                                            <asp:Button ID="btnSubmitLater" runat="server" CssClass="btn btn-primary" Text="Send Later" OnClick="btnSubmitLater_Click" OnClientClick="Javascript:return Validate();" />
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse2" onclick="SetFirstHiddenID(2);SetStatus()">Balance SMS</a>
                                                            </h4>
                                                        </div>
                                                        <div id="collapse2" class="panel-collapse collapse">
                                                            <div class="panel-body">

                                                                <!--Second panel div starts-->
                                                                <div>
                                                                    ...
                                                                    <div class="row" style="margin: 7px 0 7px 0">
                                                                        <div class="col-lg-12">
                                                                            <label class="control-label col-md-2">Product Type :<span class="required"></span></label>
                                                                            <div class="col-md-2">
                                                                                <asp:DropDownList ID="ddlBalPrdType" runat="server" CssClass="form-control" AutoPostBack="false">
                                                                                </asp:DropDownList>
                                                                            </div>

                                                                        </div>
                                                                    </div>
                                                                    <div id="Div4" class="row" style="margin: 7px 0 7px 0" runat="server" visible="false">
                                                                        <div class="col-lg-12">
                                                                            <label class="control-label col-md-2">Customer Type :<span class="required"></span></label>
                                                                            <div class="col-md-2">
                                                                                <asp:DropDownList ID="ddlBalCustType" runat="server" CssClass="form-control" OnTextChanged="ddlCustType_TextChanged" AutoPostBack="true">
                                                                                    <asp:ListItem Value="1" Text="ALL"></asp:ListItem>
                                                                                    <asp:ListItem Value="2" Text="Specific"></asp:ListItem>
                                                                                    <%-- <asp:ListItem Value="3" Text="From And To"></asp:ListItem>--%>
                                                                                </asp:DropDownList>
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <asp:TextBox ID="txtBalFromCustNo" CssClass="form-control" runat="server" placeholder="From Customer Number" OnTextChanged="txtFromCustNo_TextChanged" AutoPostBack="true" Visible="false"></asp:TextBox>
                                                                            </div>

                                                                            <div class="col-md-3">
                                                                                <asp:TextBox ID="txtBalFromCustName" placeholder="" CssClass="form-control" runat="server" Visible="false"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row" style="margin: 7px 0 7px 0">
                                                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <asp:TextBox ID="txtBalToCustNo" CssClass="form-control" runat="server" placeholder="To Customer Number" Visible="false"></asp:TextBox>
                                                                            </div>

                                                                            <div class="col-md-3">
                                                                                <asp:TextBox ID="txtBalToCustName" placeholder="" CssClass="form-control" runat="server" Visible="false"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div id="Div5" class="row" style="margin: 7px 0 7px 0;" runat="server" visible="false">
                                                                        <div class="col-lg-12">
                                                                            <label class="control-label col-md-2">Message Language :<span class="required"></span></label>
                                                                            <div class="col-md-3">
                                                                                <asp:RadioButton ID="rdbBalSMSMar" GroupName="RdbSMSGrp" runat="server" Text="Marathi" AutoPostBack="true" OnCheckedChanged="rdbSMSMar_CheckedChanged" />&nbsp;&nbsp;&nbsp;
                                                        <asp:RadioButton ID="rdbBalSMSEng" GroupName="RdbSMSGrp" runat="server" Text="English" Checked="true" AutoPostBack="true" OnCheckedChanged="rdbSMSEng_CheckedChanged" />
                                                                    ...
                                                                    <div class="row" style="margin: 7px 0 7px 0">
                                                                        <div class="col-lg-12">
                                                                            <label class="control-label col-md-2">Current Message </label>
                                                                            <div class="col-md-3">
                                                                                <asp:TextBox ID="txtBalMessage" CssClass="form-control" runat="server" TextMode="MultiLine" Columns="50" Rows="5" Visible="true" Enabled="false"></asp:TextBox>
                                                                    ...
                                                                    <div class="row" style="margin: 7px 0 7px 0">
                                                                        <div class="col-md-offset-2 col-md-8">
                                                                            <asp:Button ID="btnSendBalSMS" runat="server" CssClass="btn btn-primary" Text="Send Now" OnClick="btnSendBalSMS_Click" OnClientClick="javascript:return checkStatus()" />
