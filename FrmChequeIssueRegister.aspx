<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmChequeIssueRegister.aspx.cs" Inherits="FrmChequeIssueRegister" %>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab1">
                                        ...
                                        <div class="row" style="margin: 7px 0 7px 0">
                                            <div class="col-lg-12">
                                                <asp:RadioButton ID="rbtnSpecificProd" Text="Specific" OnCheckedChanged="SpecificProd_CheckedChanged" AutoPostBack="true" runat="server" />
                                                <asp:RadioButton ID="rbtnAllProd" Text="All" OnCheckedChanged="AllProd_CheckedChanged" AutoPostBack="true" runat="server" />
                                            </div>
                                        </div>
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover" width="100%">
                            <thead>
                                <tr>
                                    <th>
                                        <asp:GridView ID="grdChequeStockReport" runat="server" AllowPaging="True" AlternatingRowStyle-CssClass="alt" CssClass="mGrid" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="No.Of Leaves" Visible="true">
                                                    <ItemTemplate>
                                                        <asp:Label ID="NOOFLEAVES" runat="server" Text='<%# Eval("NOOFLEAVES") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="From Series">
                                                    <ItemTemplate>
