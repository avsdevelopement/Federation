...
public partial class FrmInWordreturn : System.Web.UI.Page
{
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        string url = "frmInwardAuthDo.aspx" + "?setno=" + setscroll[0] + "&scrollno=" + setscroll[1] + "&op=return";
        NewWindows(url);
    }
    ...
    protected void lnkDelete_Click(object sender, EventArgs e)
    {
        ...
        string url = "frmInwardAuthDo.aspx" + "?setno=" + setscroll[0] + "&scrollno=" + setscroll[1] + "&op=delete";
        NewWindows(url);
    }
