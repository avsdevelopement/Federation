<%@ Page Title="" Language="C#" MasterPageFile="~/CBSMaster.master" AutoEventWireup="true" CodeFile="FrmS0002_MArathi.aspx.cs" Inherits="FrmS0002_MArathi" %>
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="row" style="margin: 7px 0 7px 0">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="col-md-2">
                                                                    <asp:DropDownList ID="ddlmarathi"  AutoPostBack="true" runat="server"  CssClass="form-control" TabIndex="5">
